...
class FeeInvoicesRepository implements FeeInvoicesRepositoryInterface
{
    ...
    {
        $Fee_invoices = Fee_invoice::where('created_by',auth()->user()->id)->get();
    ...
    public function show($id)
    {
        ...
        $fees = Fee::where('created_by',auth()->user()->id)->get();
    ...
    public function edit($id)
    {
        ...
        $fees = Fee::where('created_by',auth()->user()->id)->get()->where('Classroom_id',$fee_invoices->Classroom_id)->get();
