...
preloader -->
        ...
        <div id="pre-loader">
            ...
            height: 200px;
            border-radius: 50%;"
                src="{{ URL::asset('assets/images/pre-loader/164064898_491942688846669_2030943962051623237_n.png') }}"
                alt="">
        </div>
                    ...
                    <div class="col-lg-4 col-md-6 bg-white">
                        <div class="login-fancy pb-40 clearfix">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <button class="button"><span>تسجيل دخول</span></button>
                            </form>
                        </div>
                    </div>
                </div>
