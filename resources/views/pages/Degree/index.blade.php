    ...
    <div class="col-xl-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <a type="button" class="button x-small" href="{{ route('Degree.create') }}">
                    اضافة درجات الطالب
                </a>
                <br><br>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <!-- add_form -->
                                                <form action="{{ route('Degree.update', 'test') }}" method="post">
                                                    {{ method_field('patch') }}
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col">
                ...
                <div class="col">
                    <label for="Name_en" class="mr-sm-2"> تعديل درجة الطالب
                        :</label>
                    <input type="text" class="form-control" value="{{ $degree->degree }}" name="degree_value"
                        required>
                </div>
            </div>
            <div class="form-group">
                <label for="exampleFormControlTextarea1"> تعديل اسم المادة
                    :</label>
                <select class="custom-select my-1 mr-sm-2" name="specialized_id">
