    ...
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <li>
            ...
            <ul id="sections-menu" class="collapse" data-parent="#sidebarnav">
                <li><a href="{{ route('Sections.index') }}">قائمة المجموعات</a></li>
            </ul>
        </li>
            ...
            <ul id="students-menu" class="collapse">
                <li>
                    ...
                    <ul id="Student_information" class="collapse">
                        ...
                        <li> <a href="{{ url('student_section') }}">مجموعة الطلاب</a></li>
        ...
        <!-- degrees-->
        {{-- <li>
            <a href="javascript:void(0);" data-toggle="collapse" data-target="#sections-menu44">
                <div class="pull-left"><i class="fas fa-chalkboard"></i><span class="right-nav-text">الدرجات</span>
                </div>
                <div class="pull-right"><i class="ti-plus"></i></div>
                <div class="clearfix"></div>
            </a>
            <ul id="sections-menu44" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{ route('Degree.index') }}"> قائمة الدرجات </a> </li>
                <li><a href="{{ route('Degree.create') }}">اضافه الدرجات</a></li>
        ...
        <!-- specialize-->
        <li>
            <a href="javascript:void(0);" data-toggle="collapse" data-target="#specialize-menu">
                <div class="pull-left"><i class="fas fa-user-tie"></i><span class="right-nav-text">التخصصات</span>
                </div>
                <div class="pull-right"><i class="ti-plus"></i></div>
                <div class="clearfix"></div>
            </a>
            <ul id="specialize-menu" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{ route('Specialize.index') }}"> قائمة التخصصات </a> </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{ route('Fees.create') }}"> اضافه الرسوم الدراسية </a> </li>
        ...
        <li>
            ...
            <ul id="Attendance-icon" class="collapse" data-parent="#sidebarnav">
                ...
                <li> <a href="{{ route('connect') }}">حضور عن طريق الباركود</a> </li>
            </ul>
        ...
        <li>
            ...
            <ul id="sections-menu1" class="collapse" data-parent="#sidebarnav">
                <li><a href="{{ route('report1') }}">تقرير الحضور والغياب</a></li>
                <li> <a href="{{ route('Fees.report') }}"> تقارير الفواتير </a> </li>
