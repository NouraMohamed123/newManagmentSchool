    ...
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <li>
            ...
            <ul id="sections-menu44" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{ route('Degree1.index') }}"> قائمة الدرجات </a> </li>
                <li><a href="{{ route('Degree1.create') }}">اضافه الدرجات</a></li>
        ...
        <li>
            ...
            <ul id="sections-menu1" class="collapse" data-parent="#sidebarnav">
                ...
                <li> <a href="{{ route('Fees1.report') }}"> تقارير الفواتير </a> </li>
            </ul>
                ...
                <li>
                    <a href="javascript:void(0);" data-toggle="collapse" data-target="#sections-menu2">
                        <div class="pull-left"><i class="fas fa-chalkboard"></i><span class="right-nav-text">الحضور</span>
                        </div>
                        <div class="pull-right"><i class="ti-plus"></i></div>
                        <div class="clearfix"></div>
                    </a>
                    <ul id="sections-menu2" class="collapse" data-parent="#sidebarnav">
                        <li> <a href="{{ route('connect1') }}"> الحضور عن طريق الباركود</a> </li>
                    </ul>
